...
INSIGHT = {
    ...
    "report": {
        ...
        "evidence": {
            ...
            "topics": [
                {"label": "角色与画面反馈", "count": 781, "percentage": 45.04, "description": "多数评论在夸角色表现，也有人讨论清晰度。"},
                {"label": "图片来源需求", "count": 318, "percentage": 18.34, "description": "大量用户询问原图和出处。"},
            ],
        },
        "examples": [
